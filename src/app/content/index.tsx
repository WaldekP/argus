...
/**
 * Analiza przekazu (dawna zakładka Przekaz, teraz pod zakładką Analizy):
 * lista draftów generatora + wejście do nowego przekazu.
 */
export default function ContentScreen() {
  ...
  // Odświeżamy listę przy każdym wejściu na ekran (powrót z draftu,
    ...
    <ThemedView style={styles.screen}>
      <ScrollView
        ...
        <View style={styles.header}>
          <ThemedText style={styles.title}>Analiza przekazu</ThemedText>
          <ThemedText themeColor="textSecondary">
            Jeden temat, warianty treści per segment wyborców i kanał, w Twoim stylu. Każdy
            przekaz przechodzi kontrolę spójności z historią wypowiedzi.
          </ThemedText>
        </View>
